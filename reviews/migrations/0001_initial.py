# Generated by Django 4.0 on 2022-11-18 06:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_names', models.CharField(help_text='The contributors last names', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text="publisher's name", max_length=255)),
                ('website', models.URLField(help_text="publisher's website")),
                ('email', models.EmailField(help_text="publishers's email", max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
